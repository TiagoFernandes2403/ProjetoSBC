...
perfilConsumidor(3):- procuraPrato(geral,lisboa_vale_tejo,carne,i16_30).
perfilConsumidor(4):- procuraPrato(ligeira,lisboa_vale_tejo,carne,i16_30).
perfilConsumidor(5):- procuraPrato(geral,alentejo_algarve,carne,i16_30).
perfilConsumidor(6):- procuraPrato(ligeira,alentejo_algarve,carne,i16_30).

perfilConsumidor(7):- procuraPrato(geral,norte_centro,peixe,i16_30).
perfilConsumidor(8):- procuraPrato(ligeira,norte_centro,peixe,i16_30).
perfilConsumidor(9):- procuraPrato(geral,lisboa_vale_tejo,peixe,i16_30).
perfilConsumidor(10):- procuraPrato(ligeira,lisboa_vale_tejo,peixe,i16_30).
perfilConsumidor(11):- procuraPrato(geral,alentejo_algarve,peixe,i16_30).
perfilConsumidor(12):- procuraPrato(ligeira,alentejo_algarve,peixe,i16_30).

perfilConsumidor(13):- procuraPrato(geral,norte_centro,ovo,i16_30).
perfilConsumidor(14):- procuraPrato(ligeira,norte_centro,ovo,i16_30).
perfilConsumidor(15):- procuraPrato(geral,lisboa_vale_tejo,ovo,i16_30).
...
perfilConsumidor(18):- procuraPrato(ligeira,alentejo_algarve,ovo,i16_30).

perfilConsumidor(19):- procuraPrato(geral,norte_centro,carne,i31_50).
perfilConsumidor(20):- procuraPrato(ligeira,norte_centro,carne,i31_50).
perfilConsumidor(21):- procuraPrato(geral,lisboa_vale_tejo,carne,i31_50).
perfilConsumidor(22):- procuraPrato(ligeira,lisboa_vale_tejo,carne,i31_50).
perfilConsumidor(23):- procuraPrato(geral,alentejo_algarve,carne,i31_50).
perfilConsumidor(24):- procuraPrato(ligeira,alentejo_algarve,carne,i31_50).

perfilConsumidor(25):- procuraPrato(geral,norte_centro,peixe,i31_50).
perfilConsumidor(26):- procuraPrato(ligeira,norte_centro,peixe,i31_50).
perfilConsumidor(27):- procuraPrato(geral,lisboa_vale_tejo,peixe,i31_50).
perfilConsumidor(28):- procuraPrato(ligeira,lisboa_vale_tejo,peixe,i31_50).
perfilConsumidor(29):- procuraPrato(geral,alentejo_algarve,peixe,i31_50).
perfilConsumidor(30):- procuraPrato(ligeira,alentejo_algarve,peixe,i31_50).

perfilConsumidor(31):- procuraPrato(geral,norte_centro,ovo,i31_50).
perfilConsumidor(32):- procuraPrato(ligeira,norte_centro,ovo,i31_50).
perfilConsumidor(33):- procuraPrato(geral,lisboa_vale_tejo,ovo,i31_50).
perfilConsumidor(34):- procuraPrato(ligeira,lisboa_vale_tejo,ovo,i31_50).
perfilConsumidor(35):- procuraPrato(geral,alentejo_algarve,ovo,i31_50).
perfilConsumidor(36):- procuraPrato(ligeira,alentejo_algarve,ovo,i31_50).

perfilConsumidor(37):- procuraPrato(geral,norte_centro,carne,i51_mais).
perfilConsumidor(38):- procuraPrato(ligeira,norte_centro,carne,i51_mais).
perfilConsumidor(39):- procuraPrato(geral,lisboa_vale_tejo,carne,i51_mais).
perfilConsumidor(40):- procuraPrato(ligeira,lisboa_vale_tejo,carne,i51_mais).
perfilConsumidor(41):- procuraPrato(geral,alentejo_algarve,carne,i51_mais).
perfilConsumidor(42):- procuraPrato(ligeira,alentejo_algarve,carne,i51_mais).

perfilConsumidor(43):- procuraPrato(geral,norte_centro,peixe,i51_mais).
perfilConsumidor(44):- procuraPrato(ligeira,norte_centro,peixe,i51_mais).
perfilConsumidor(45):- procuraPrato(geral,lisboa_vale_tejo,peixe,i51_mais).
perfilConsumidor(46):- procuraPrato(ligeira,lisboa_vale_tejo,peixe,i51_mais).
perfilConsumidor(47):- procuraPrato(geral,alentejo_algarve,peixe,i51_mais).
perfilConsumidor(48):- procuraPrato(ligeira,alentejo_algarve,peixe,i51_mais).

perfilConsumidor(49):- procuraPrato(geral,norte_centro,ovo,i51_mais).
perfilConsumidor(50):- procuraPrato(ligeira,norte_centro,ovo,i51_mais).
perfilConsumidor(51):- procuraPrato(geral,lisboa_vale_tejo,ovo,i51_mais).
perfilConsumidor(52):- procuraPrato(ligeira,lisboa_vale_tejo,ovo,i51_mais).
perfilConsumidor(53):- procuraPrato(geral,alentejo_algarve,ovo,i51_mais).
perfilConsumidor(54):- procuraPrato(ligeira,alentejo_algarve,ovo,i51_mais).

perfilConsumidor(55):- procuraAutoSeletiva(ovo_lacteo_vegetariano).
perfilConsumidor(56):- procuraAutoSeletiva(vegano).
perfilConsumidor(57):- procuraAutoSeletiva(fast_food).
