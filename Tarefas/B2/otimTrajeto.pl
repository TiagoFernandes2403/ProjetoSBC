...
:- [baseDados, menorDistancia, hillclimbing].
...
resultado(Metodo) :-
    (Metodo == 'menorDistancia', restaurant(_,LE,_), random_member(E,LE), nl,write('Entregar para:'),write(E),nl,nl, menorDistancia(restaurante, E));
